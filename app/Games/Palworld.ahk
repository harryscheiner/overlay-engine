Class Palworld extends Game {
  ...
  setOverlays() {
    ...
    Overlays.Camera := new Overlay({transparency: 100})
    Overlays.General := new Overlay({transparency: 170})
    Overlays.Menus := new Overlay({transparency: 170})
  ...
  setRegions() {
    ...
    ; Overlay: Menus
    Overlays.Menus.addRegion("GenInv",              {text: "Inv", color: "0x000000", background: "0x3088F3", keys: [Keys.Inventory], mode: "press"})
    Overlays.Menus.addRegion("GenBuild",            {text: "Build", color: "0x000000", background: "0x3088F3", keys: [Keys.Build], mode: "press"})
    Overlays.Menus.addRegion("GenMap",              {text: "Map", color: "0x000000", background: "0x3088F3", keys: [Keys.Map], mode: "press"})
  ...
  setRegionPositions() {
    ...
    ; Menus (anchored relative to screen center)
    Overlays.Menus.regions.press.GenInv.updateOpts( {x: centerX - Floor(164 * scaleH), y: centerY + Floor(225 * scaleH), w: Floor(46 * scaleH), h: Floor(40 * scaleH)})
    Overlays.Menus.regions.press.GenBuild.updateOpts( {x: centerX - Floor(117 * scaleH), y: centerY + Floor(225 * scaleH), w: Floor(46 * scaleH), h: Floor(40 * scaleH)})
    Overlays.Menus.regions.press.GenMap.updateOpts( {x: centerX - Floor(70 * scaleH),  y: centerY + Floor(225 * scaleH), w: Floor(46 * scaleH), h: Floor(40 * scaleH)})
  ...
  hook_MidOverlayLoop() {
    ...
    Overlays.Menus.newState := true ; Always visible
